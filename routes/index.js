...
router.get('/', function(req, res, next) {
  rpn(options).then( function(results) {
    ...
    res.render('index', { title: 'Weather Conditions in ' + results.current_observation.display_location.full, weather: results.current_observation.weather, update: results.current_observation.observation_time, temp: results.current_observation.temp_f, realfeel: results.current_observation.feelslike_f, humidity: results.current_observation.humidity, rain: results.current_observation.percip_today_in, heat: results.current_observation.heat_index_f,  });
});
  });
